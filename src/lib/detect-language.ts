...
const SCRIPT_RULES: LangRule[] = [
  ...
  // ベトナム語に化ける）。ベトナム語固有の ă đ ơ ư と、声調符号付き母音
  // （U+1EA0-1EF9: ạ ả ấ ầ ậ ế ệ ố ồ ộ ớ ờ ợ ứ ừ ự等）で判定する。
  // 声調符号を含めないと "Rất ngon và sạch sẽ" のような文が英語と誤判定される
  { lang: "ベトナム語", country: "ベトナム", pattern: /[ăđơưĂĐƠƯẠ-ỹ]/ },
