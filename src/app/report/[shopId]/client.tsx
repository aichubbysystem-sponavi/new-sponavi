                      ...
                      {snapshot ? (
                        <>
                          ...
                          <div className="grid-kw-legend" style={{ display: "flex", fontSize: 18, lineHeight: 1, color: "#555", marginTop: 4, width: 440, justifyContent: "space-between" }}>
                            <span style={{ display: "flex", alignItems: "baseline", gap: 6 }}><span style={{ width: 20, height: 20, borderRadius: "50%", background: "#2563EB", display: "inline-block", flexShrink: 0, position: "relative", top: 3 }} />1-3位</span>
                            <span style={{ display: "flex", alignItems: "baseline", gap: 6 }}><span style={{ width: 20, height: 20, borderRadius: "50%", background: "#16A34A", display: "inline-block", flexShrink: 0, position: "relative", top: 3 }} />4-10位</span>
                            <span style={{ display: "flex", alignItems: "baseline", gap: 6 }}><span style={{ width: 20, height: 20, borderRadius: "50%", background: "#F59E0B", display: "inline-block", flexShrink: 0, position: "relative", top: 3 }} />11-20位</span>
                            <span style={{ display: "flex", alignItems: "baseline", gap: 6 }}><span style={{ width: 20, height: 20, borderRadius: "50%", background: "#EF4444", display: "inline-block", flexShrink: 0, position: "relative", top: 3 }} />21位~</span>
                            <span style={{ display: "flex", alignItems: "baseline", gap: 6 }}><span style={{ width: 20, height: 20, borderRadius: "50%", background: "#6B7280", display: "inline-block", flexShrink: 0, position: "relative", top: 3 }} />圏外</span>
                          </div>
