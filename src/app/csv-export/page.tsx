...
const ITEMS: ExportItem[] = [
  ...
  },
  {
    type: "insights-gbp",
    label: "インサイト（GBP形式）",
    desc: "GBP管理画面のインサイトCSVと同じ列構成（ビジネス名／検索・マップのモバイル・PC／通話／メッセージ／予約／ルート／ウェブサイト／料理の注文／フードメニュー／ホテルの予約）",
    note: "ホテルの予約は同期対象外のため常に0",
  },
  {
  ...
  },
  {
    type: "review-summary",
    label: "口コミ点数・件数",
    desc: "全店舗の現在の点数（★）と口コミ件数（Googleマップ掲載値・実行時点）",
    note: "月の選択に関係なく、実行した時点の最新値を出力します",
  },
  {
    type: "posts",
    label: "投稿ログ",
