...
■ 正しい出力例
{
  ...
  "keywordComment": "「一社 イタリアン」「名東区 パスタ」が<strong>1位から圏外に転落</strong>しており、オーガニック流入への影響が懸念される。他のキーワードは順位を維持しているため、転落した2語の原因特定と早期回復が最優先の対応となる",
  "rankingHistoryComment": "「名東区 レストラン」は1月の11位から4月の3位まで改善したが、<strong>直近2計測は下降</strong>に転じている。数ヶ月かけて積み上げた上昇分を手放さないよう、推移を注視しながら上位表示の要因を維持することが重要となる",
  ...
  try {
    ...
    const res = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        // ページ総評を1文→2〜3文に増量したため出力が長くなる（12フィールド×最大180字）。4096だと途中で切れるリスクがある
        max_tokens: 8192,
